...
export const Success = ({ message, autoClose,message1 }) => {
    ...
    toast.success(
      <p className="w-[100%]">
        ...
        {message1}
        <br/>
        <a href={message} target="_blank" className={`text-blue ${message?'flex':'hidden'}`}>Click Here</a>
      </p>,

      {
        icon: ({ theme, type }) => <img src="/assets/4 toaster/head 1.png" alt="success img" />,
