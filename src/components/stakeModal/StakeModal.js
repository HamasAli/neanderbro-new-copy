...
const StakeModal = ({
  ...
  const { SetApproval } = useMintingStateContext();
  ...
  return (
    <div>
      {isOpen && (
        <div className="fixed bg-black backdrop-blur-sm bg-opacity-[50%]   w-full inset-0  flex items-center justify-center z-40">
          ...
          <div className=" bg-[#000F1F] border border-blue relative gap-3 p-8 flex flex-col justify-center items-center rounded-xl shadow-md w-[80%] lg:w-1/3">
            <div className="flex items-center justify-center ">
              <h2 className="text-lg font-semibold xl:text-2xl md:text-xl text-yellow lg:font-bold">
                Approval Request
              </h2>
            ...
            <p className="text-center text-white text-md">
              NeanderBros wants an approval before staking your NFT. Please
              click on the approve button below to Approve the staking contract
              to use your NFTs.
            </p>
            <div className="flex flex-col gap-3 justify-center items-center w-[50%]">
              <Button
                onClick={() =>
                  gal === true ? handleNGApproved() : handleApproved()
                }
