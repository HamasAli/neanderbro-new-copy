...
export default function TermsNConditionSection() {
  const termsNConditionContent = content.termsNCondition;
  return (
    <div className="py-36 flex flex-col gap-4 items-center">
      <div className="text-center mb-8 2xl:mt-12">
        <CustomH2Heading
          ...
          privacyText={["Terms & Conditions"]}
        />
      </div>

      <div className="flex flex-col gap-10 w-[90%] sm:w-[80%] lg:w-2/4">
        {termsNConditionContent.map((item, index) => (
